...
using Root_Way.ResourcesNamespace;
...
public class HomeWindowViewModel : ViewModelBase
{
    ...
    internal static HomeWindowViewModel Instance { get; private set; }
        ...
        {
            var window = Utilities.ShowAddPage<AddGradeWindow, AddGradeViewModel>(out var viewModel, HomeWindowInstance);
            EditElement(grade, viewModel, window);
        }

        private void EditSubject(Subject subject) // I wish I could use a generic method here :(
        {
            var window = Utilities.ShowAddPage<AddSubjectWindow, AddSubjectViewModel>(out var viewModel, HomeWindowInstance);
            EditElement(subject, viewModel, window);
        }

        private void EditYear(SchoolYear year) // I wish I could use a generic method here :(
        {
            var window = Utilities.ShowAddPage<AddYearWindow, AddYearViewModel>(out var viewModel, HomeWindowInstance);
        ...
        {
            Utilities.ShowAddPage(Content.AddPageType, Content.AddViewModelType, HomeWindowInstance, out var addViewModel);
